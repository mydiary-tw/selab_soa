package tw.com.cardif.selab.config.timezone;

import tw.com.cardif.selab.SelabApp;
import tw.com.cardif.selab.repository.timezone.DateTimeWrapper;
import tw.com.cardif.selab.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = SelabApp.class)
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM se_date_time_wrapper where id=%d", fieldName, id);
    }
